        ...
        <fieldset>
			...
			<tfoot>
				<tr class="first last">
					...
					<button type="button" title="Continue Shopping" class="button btn-continue" onClick="window.location='{!! url('products') !!}';"><span><span>Continue Shopping</span></span></button>
					<button type="submit" name="update_cart_action" value="update_qty" title="Update Cart" class="button btn-update"><span><span>Update Cart</span></span></button>
					 {!! Form::open(array('url' => '/cart/clear','method'=>'post')) !!}
				...
				<tr id="{!! $c['cart_id'] !!}" class="<?php echo ($count==1 ? "first":"");?> <?php echo ($count==$length ? "last":"");?> <?php echo ($count %2==0? "odd":"even");?>">
					...
					<td>
						<h2 class="product-name">
							<a href="product-detail.html">{!! $c['name'] !!}</a>
						</h2>
					</td>
					...
					<td class="a-center movewishlist">
						<input name="cart[26340][qty]" value="{!! $c['qty'] !!}" size="4" title="Qty" class="input-text qty" maxlength="12">
					</td>
					<td class="a-right movewishlist">
						<span class="cart-price">
							<span class="price">RS.{!! $c['unitPrice'] !!}</span>                            
						</span>
					</td>
					<td class="a-center last">
						<a title="Remove item" class="button remove-item" onClick="return removeItemFromCart({!! $c['cart_id'] !!})">
		...
		<tfoot>
            <tr>
				...
				<td style="" class="a-right">
					<strong><span class="price">RS.{!! $cart['totalPrice'] !!}</span></strong>
				</td>
			</tr>
        </tfoot>
        <tbody>
            <tr>
				<td style="" class="a-left" colspan="1">
					Subtotal    </td>
				<td style="" class="a-right">
					<span class="price">RS.{!! $cart['totalPrice'] !!}</span>    </td>
			</tr>
        </tbody>
    </table>
...
<ul class="checkout">           
<li>
    <button type="button" title="Proceed to Checkout" class="button btn-proceed-checkout" onClick="window.location='{!! url('checkout/method') !!}';"><span>Proceed to Checkout</span></button>
</li><br>
</ul>                
</div><!--inner-->
 </div><!--totals-->
