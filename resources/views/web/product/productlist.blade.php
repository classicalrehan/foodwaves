    ...
    <div class="header-container container">
	 <div class="row">
      <div class="logo"> <a href="index.html" title="Flavours HTML">
        <div>
		{!! Html::image('web/images/logo.png','Flavours Store')!!}</div>
        </a> </div>
          ...
          <nav>
            ...
            <div class="nav-inner">
              ...
              <ul id="nav" class="hidden-xs">
                <li id="nav-home" class="level0 parent drop-menu"><a class="level-top active" href="index.html"><span>Home</span></a>
            ...
            <div class="fl-mini-cart-content" style="display: none;">
              ...
              <ul class="mini-products-list" id="cart-sidebar">
                <li class="item first">
				  ...
				  {!! Html::image('web/products-images/p4.jpg','menu_image')!!}
				  </a>
                ...
                <li class="item last">
                  <div class="item-inner"><a class="product-image" title="JP Lizzy Satchel Designer Diaper Bag - Slate Citron" href="#">{!! Html::image('web/products-images/p3.jpg','menu_image')!!}</a>
                    <div class="product-details">
                      <div class="access"><a class="btn-remove1" title="Remove This Item" href="#">Remove</a> <a class="btn-edit" title="Edit item" href="#"><i class="icon-pencil"></i><span class="hidden">Edit item</span></a> </div>
                      <!--access-->
  ...
  <div class="page-heading">
    ...
    <section class="main-container col2-left-layout bounceInUp animated">
      ...
      <div class="container">               
       ...
       <div class="row">
        ...
        <article class="col-main">
          ...
          <li class="item first">
			...
			{!! Html::image('web/products-images/p1.jpg','HTC Rhyme Sense',array('class'=>'small-image')) !!}
			 </a> </div>
          ...
          <li class="item even">
            <div class="product-image"> <a href="product-detail.html" title="Microsoft Natural Keyboard"> 
			{!! Html::image('web/products-images/p2.jpg','HTC Rhyme Sense',array('class'=>'small-image')) !!}
			 </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product-detail.html" title="Microsoft Natural Keyboard">Microsoft Natural Keyboard</a></h2>
              <div class="desc std">
                <p>Sed volutpat ac massa eget 
          ...
          <li class="item odd">
            <div class="product-image"> <a href="product-detail.html" title="30&quot; Flat-Panel HD Monitor"> 
			{!! Html::image('web/products-images/p3.jpg','HTC Rhyme Sense',array('class'=>'small-image')) !!}
			 </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product-detail.html" title="30&quot; Flat-Panel HD Monitor">30" Flat-Panel HD Monitor</a></h2>
          ...
          <li class="item even">
            <div class="product-image"> <a href="product-detail.html" title="19&quot; Widescreen LCD Monitor"> 
			{!! Html::image('web/products-images/p4.jpg','HTC Rhyme Sense',array('class'=>'small-image')) !!}
			 </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product-detail.html" title="19&quot; Widescreen LCD Monitor">19" Widescreen LCD Monitor</a></h2>
          ...
          <li class="item odd">
            <div class="product-image"> <a href="product-detail.html" title="Seagate 250GB HD "> 
			{!! Html::image('web/products-images/p5.jpg','HTC Rhyme Sense',array('class'=>'small-image')) !!}
			 </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product-detail.html" title="Seagate 250GB HD ">Seagate 250GB HD </a></h2>
          ...
          <li class="item even">
            <div class="product-image"> <a href="product-detail.html" title="Seagate 500GB HD"> 
			{!! Html::image('web/products-images/p6.jpg','HTC Rhyme Sense',array('class'=>'small-image')) !!}
			 </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product-detail.html" title="Seagate 500GB HD">Seagate 500GB HD</a></h2>
              <div class="desc std">1 TB - 7200RPM, SATA 3.0Gb/s, 32MB Cache
          ...
          <li class="item odd">
            <div class="product-image"> <a href="product-detail.html" title="Intel Core 2 Extreme QX9775"> 
			{!! Html::image('web/products-images/p7.jpg','HTC Rhyme Sense',array('class'=>'small-image')) !!}
			</a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product-detail.html" title="Intel Core 2 Extreme QX9775">Intel Core 2 Extreme QX9775</a></h2>
          ...
          <li class="item even">
            <div class="product-image"> <a href="product-detail.html" title="24&quot; Widescreen LCD Monitor"> 
			{!! Html::image('web/products-images/p8.jpg','HTC Rhyme Sense',array('class'=>'small-image')) !!}
			 </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product-detail.html" title="24&quot; Widescreen LCD Monitor">24" Widescreen LCD Monitor</a></h2>
          ...
          <li class="item odd">
            <div class="product-image"> <a href="product-detail.html" title="Logitech Optical Trackman"> 
			{!! Html::image('web/products-images/p9.jpg','HTC Rhyme Sense',array('class'=>'small-image')) !!}
			 </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product-detail.html" title="Logitech Optical Trackman">Logitech Optical Trackman</a></h2>
          ...
          <li class="item last even">
            <div class="product-image"> <a href="product-detail.html" title="Logitech diNovo Edge Keyboard"> 
			{!! Html::image('web/products-images/p10.jpg','HTC Rhyme Sense',array('class'=>'small-image')) !!}
			 </a> </div>
            <div class="product-shop">
              <h2 class="product-name"><a href="product-detail.html" title="Logitech diNovo Edge Keyboard">Logitech diNovo Edge Keyboard</a></h2>
              <div class="ratings">
                <div class="rating-box">
          ...
          <div>
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
				...
				{!! Html::image('web/images/slide3.jpg','slide3',array('class'=>'')) !!}
                ...
                <div class="item">
				{!! Html::image('web/images/slide1.jpg','slide3',array('class'=>'')) !!}
                ...
                <div class="item">
				{!! Html::image('web/images/slide2.jpg','slide3',array('class'=>'')) !!}
          ...
          <div class="block-content">
            ...
            <ul id="cart-sidebar" class="mini-products-list">
              <li class="item">
				...
				{!! Html::image('web/products-images/p1.jpg','product',array('class'=>'','width'=>'80')) !!}
				</a>
                  <div class="product-details">
              ...
              <li class="item  last1">
                <div class="item-inner"> <a href="#" class="product-image">
				{!! Html::image('web/products-images/p2.jpg','product',array('width'=>'80')) !!}
				</a>
                  <div class="product-details">
                    <div class="access"> <a href="#" class="btn-remove1">Remove</a> 
                    <a href="" title="Edit item" class="btn-edit">
	   ...
	   {!! Html::image('web/images/hot-trends-banner.jpg','product',array('width'=>'80')) !!}
	   </div> 
		<div class="hot-banner">
	   {!! Html::image('web/images/hot-trends-banner.jpg','product',array('width'=>'80')) !!}
	   </div>	   
      ...
      <div class="container">
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 col"> 
            ...
            <div class="payment-accept">
              <div>
			  {!! Html::image('web/images/payment-1.png','blog image')!!}
			  
			  {!! Html::image('web/images/payment-2.png','blog image')!!}
			  
			  {!! Html::image('web/images/payment-3.png','blog image')!!}
			  
			  {!! Html::image('web/images/payment-4.png','blog image')!!}
			  </div>
            </div>
          </div>
          <!-- Footer Newsletter -->
      ...
      <div class="container">
        <div class="row">
		  ...
		  <div class="co-info">
			  ...
			  {!! Html::image('web/images/logo.png','blog image')!!}
			  </a></div>
              <address>
