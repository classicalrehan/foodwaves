              ...
              <form action="" method="post" id="product_addtocart_form">
                  ...
                  <div class="product-image">
                    ...
                    <!-- <div class="flexslider flexslider-thumb">
                      <ul class="previews-list slides">
                        ...
                        <li><a href='{!! url("web/products-images/p10.jpg")!!}' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '{!! url("web/products-images/p10.jpg") !!}' ">
						{!! Html::image('web/products-images/p10.jpg','Flavours Store')!!}</a></li>
                        <li><a href='{!! url("web/products-images/p3.jpg")!!}' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '{!! url("web/products-images/p3.jpg") !!}' ">{!! Html::image('web/products-images/p3.jpg','Flavours Store')!!}</a></li>
                        <li><a href='{!! url("web/products-images/p4.jpg")!!}' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '{!! url("web/products-images/p4.jpg") !!}' ">{!! Html::image('web/products-images/p4.jpg','Flavours Store')!!}</a></li>
                        <li><a href='{!! url("web/products-images/p5.jpg")!!}' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '{!! url("web/products-images/p5.jpg") !!}' ">{!! Html::image('web/products-images/p5.jpg','Flavours Store')!!}</a></li>
                ...
                <div class="product-shop col-sm-6 col-xs-12">
                  ...
                  <div class="price-block">
                    <div class="price-box"> <span class="regular-price" id="product-price-123"> <span class="price">RS.{!! $product['price'] !!}</span> </span> </div>
                    ...
                    <div class="add-to-cart">
                      <div class="pull-left">
                        <div class="custom pull-left">
                          <button onClick="var result = document.getElementById('qty-{!! $product['id'] !!}'); var qty = result.value; if( !isNaN( qty ) &amp;&amp; qty &gt; 0 ) result.value--;return false;" class="reduced items-count" type="button"><i class="icon-minus">&nbsp;</i></button>

                          <input type="text" name="qty" id="qty-{!! $product['id'] !!}" maxlength="12" value="1" title="Quantity:" class="input-text qty">
                          
                           <button onClick="var result = document.getElementById('qty-{!! $product['id'] !!}'); var qty = result.value; if( !isNaN( qty )) result.value++;return false;" class="increase items-count" type="button"><i class="icon-plus">&nbsp;</i></button>
                        </div>
                        <!--custom pull-left-->
                      </div>
                      <!--pull-left-->
                      <button type="button" title="Add to Cart" class="button btn-cart" onClick="return addToCart({!! $product['id'] !!},{!! $product['price'] !!});"><span><i class="icon-basket"></i>Add to Cart</span></button>
                    </div>
                    <!--add-to-cart-->
