          ...
          <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Enter Use Information</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                {!! Form::open(array('url' => '/user/store','method'=>'post','class'=>'form-horizontal')) !!}
                  <div class="box-body">
                  ...
                  <div class="box-footer">
					...
					{!! Form::submit('Add User',array('class'=>'btn btn-info pull-right')) !!}
                  </div><!-- /.box-footer -->
                {!! Form::close() !!}
              </div>
