	 ...
	 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
			{!! Form::open(array('url' => '/subcategory/store','method'=>'post','class'=>'form-horizontal','id'=>'fileupload', 'files'=>true)) !!}
             ...
             <div class="box box-info">
				...
				<div class="box-body">
				 ...
				 <div class="box-footer">
					{!! Form::submit('Add Sub Category',array('class'=>'btn btn-info pull-right')) !!}
                  </div><!-- /.box-footer -->
			 </div>
			 {!! Form::close() !!}
			  <div class="box box-info">
