                    ...
                    <tbody>
						@foreach($category as $cat)
							<tr id="{!! $cat->childID !!}">
								...
								<td>
									<a  class="btn btn-primary" href="{!! url('subcategory/edit/'.$cat->childID) !!}" data-id="{!! $cat->childID !!}"><i class="fa fa-edit"></i> Edit</a>
								
									<a data-toggle="modal" class="btn btn-primary" href="#categoryDeleteModel" data-id="{!! $cat->childID !!}"><i class="fa fa-trash"></i> Delete</a></td>
							</tr>
						@endforeach
      ...
      $(function () {
		...
		$("#deleteCategory").click(function(){
			...
			$token=$('input[name=_token]').val();
			 var route = "{{ url('subcategoy/destroy') }}";
			$.ajax({
			  url: route,
			  type: "post",
