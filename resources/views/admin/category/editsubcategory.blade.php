	 ...
	 <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
			{!! Form::open(array('url' => '/subcategory/update','method'=>'post','class'=>'form-horizontal','id'=>'fileupload', 'files'=>true)) !!}
                ...
                <!-- form start -->
                  ...
                  <div class="box-body">
                      ...
                      <div class="col-sm-10">
                       <select class="form-control" name="category">
                        @foreach($category as $cat)
							<option value='{!! $cat->id !!}' {!! $cat->id==$categoryInfo['is_parent']?'selected':'' !!}>{!! $cat->name !!}</option>
						@endforeach
                      </select>
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-10">
                        {!! Form::text('name', $categoryInfo['name'],array('class'=>'form-control','placeholder'=>'Category Name','required'=>true)) !!}
						{!! Form::hidden('id', $categoryInfo['id']) !!}
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
						{!! Form::text('description', $categoryInfo['description'],array('class'=>'form-control','placeholder'=>'Category Description','required'=>true)) !!}
                      </div>
                    </div>
                  </div><!-- /.box-body -->
             ...
             <div class="box box-info">
				...
				<div class="box-body">
				 ...
				 <div class="box-footer">
					{!! Form::submit('Update Sub Category',array('class'=>'btn btn-info pull-right')) !!}
                  </div><!-- /.box-footer -->
			 </div>
			 {!! Form::close() !!}
			  <div class="box box-info">
