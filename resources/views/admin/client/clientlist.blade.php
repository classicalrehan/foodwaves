                    ...
                    <tbody>
						@foreach($clients as $client)
							<tr id="{!! $client->id !!}">
								...
								<td>
									<a  class="btn btn-primary" href="{!! url('client/edit/'.$client->id) !!}" data-id="{!! $client->id !!}"><i class="fa fa-edit"></i> Edit</a>
									
									<a data-toggle="modal" class="btn btn-primary" href="#clientDeleteModel" data-id="{!! $client->id !!}"><i class="fa fa-trash"></i> Delete</a>
								</td>
							</tr>
						@endforeach
	...
	<form method="post">	
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Are you absolutely sure you want to delete. There is no undo for this client?</p>
        </div>
