		...
		@if(Session::has('error'))
			<section class="content-header">	
				<div class="alert alert-danger alert-dismissable">
					...
					Error in adding new client. Please try again later!
          ...
          <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Enter Client Information</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                {!! Form::open(array('url' => '/client/store','method'=>'post','class'=>'form-horizontal')) !!}
                  <div class="box-body">
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">User Name</label>
                      <div class="col-sm-10">
                        {!! Form::text('name', '',array('class'=>'form-control','placeholder'=>'User Name','required'=>true)) !!}
                      </div>
                    </div>
					<div class="form-group">
                  ...
                  <div class="box-footer">
					...
					{!! Form::submit('Add Client',array('class'=>'btn btn-info pull-right')) !!}
                  </div><!-- /.box-footer -->
                {!! Form::close() !!}
              </div>
